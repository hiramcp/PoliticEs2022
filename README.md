...
## Source Code
There are two different source code files for every kind of classifier, task_solver contains Gradient Boosting approach and task_solver_svm contains both SVM Linear and SVM RBF approaches.
